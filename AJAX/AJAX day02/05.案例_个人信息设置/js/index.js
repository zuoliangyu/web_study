 ...
 * */
 ...
 document.querySelector('.submit').addEventListener('click',function(){
    ...
    const userInfo = serialize(userForm,{hash:true,empty:true})
    ...
    axios({
      ...
      console.log(res)
      const t = document.querySelector('.my-toast')
      const myToast = new bootstrap.Toast(t)
      myToast.show()
    })
 })
