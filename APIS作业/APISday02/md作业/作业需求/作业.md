...
<body>
  ...
  <script>
    /*
      ...
      (2)如果想要实现正确的需求,应该如何实现
    */
    const btns = document.querySelector('button')    //const btns = document.querySelectorAll('button')
...
<body>
  ...
  <script>
    ...
    */
    ...
    tx.addEventListener('keyup', function () {   // tx.addEventListener('keyup', function ( e ) {
      if (e.key === Enter) {
        alert('您按下了回车键')
      }
    })
